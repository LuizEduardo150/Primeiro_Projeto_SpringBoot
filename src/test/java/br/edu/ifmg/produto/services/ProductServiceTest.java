...
class ProductServiceTest {
    ...
    @Test
    @DisplayName("Verificando se objeto foi deletado no BD caso exista.")
    ...
    @Test
    @DisplayName("Verificando se levanta uma exceçao se não existe no BD")
    ...
    @Test
    @DisplayName("Verificando busca de um produto, por um ID existente")
